<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMenage/BackAdmin.Master" AutoEventWireup="true" CodeBehind="productsList.aspx.cs" Inherits="web09052024.AdminMenage.productsList" %>
                            ...
                            <asp:Repeater ID="RptProd" runat="server">
                                <ItemTemplate>
                                    <tr class="odd gradeX">
                                        ...
                                        <td><%#Eval("pName") %></td>
                                        <td><%#Eval("price") %></td>
                                        <td class="center"><img src="uploads/pic/<%#Eval("PicName")%>" width="50" /> </td>
                                        <td class="center"><a href="prodAddEdit.aspx?Pid=<%#Eval("Pid") %>">ערוך <spann class="fa fa-pencil"></spann></a></td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater> 
                        </tbody>
