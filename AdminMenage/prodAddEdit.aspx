<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMenage/BackAdmin.Master" AutoEventWireup="true" CodeBehind="prodAddEdit.aspx.cs" Inherits="web09052024.AdminMenage.prodAddEdit" %>
                    ...
                    <div class="col-lg-6">
                        <asp:HiddenField ID="hidPid" runat="server" Value="-1"/>
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="TxtPic" CssClass="form-control" runat="server" placeholder="נא הזן שם תמונה"/>
                            </div> 
